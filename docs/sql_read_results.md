...
Cohort `2024A` had the highest average pre-work score (81.8), indicating this cohort performed slightly better on pre-work than others.
...
`Aisha Al-Rashidi` submitted all three projects on time with high grades (88–95), indicating she is consistent and engaged.